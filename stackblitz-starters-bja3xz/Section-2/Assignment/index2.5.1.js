...
/********************* Flip Deal Product Listing Page 2.5_Assignemnt - 01 *********************/
...
function sortProductsPopularity(product1, product2) {
  return product2.rating - product1.rating;
}

app.get("/products/sort/popularity", (req, res) => {
  let sortedProducts = products.slice();
  sortedProducts.sort(sortProductsPopularity);
...
app.get("/products/filter/brand", (req, res) => {
  ...
  let sortedProducts = products.slice();
  sortedProducts = products.filter(product => filterByBrand(product, brand));
  res.json(sortedProducts);
});
...
app.get("/products/filter/price", (req, res) => {
  ...
  let sortedProducts = products.slice();
  sortedProducts = products.filter(product => filterByPrice(product, price));
  res.json(sortedProducts);
});
